...
public class KillCows extends DisposableTask
{
	...
	public Area COW_PATCH = Area.polygonal( new Position( 3265, 3298 ),
											new Position( 3265, 3255 ),
											new Position( 3253, 3255 ),
											new Position( 3253, 3278 ),
											new Position( 3244, 3278 ),
											new Position( 3244, 3298 ) );
	...
	public List<String> ENEMIES = Arrays.asList( "Cow", "Cow calf" );
												
	//change this to be the tile direclty on the other side of gate
	public Position INSIDE_COW_PATCH = new Position( 3259, 3279 ); 
	...
	public int execute()
	{
		...
		if ( Npcs.getNearest(n -> ENEMIES.contains( n.getName() ) ) == null )
		{
			Debug.out( "Walking to cow patch" );
			Movement.walkTo( INSIDE_COW_PATCH );
			Time.sleep( 0, 700 );
		}
		else if ( readyToLoot() )
		{
